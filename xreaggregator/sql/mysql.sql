CREATE TABLE xreaggregator (
	...
	xreaggregator_cid smallint(3) unsigned NOT NULL auto_increment,
...
INSERT INTO xreaggregator VALUES (1, 1, 'XOOPS Official Website', 'http://www.xoops.org/', 'http://www.xoops.org/backend.php', 'ISO-8859-1', 86400, 0, 1, 0, 1, 1, 10, 0, 10, '', 0, '|all');
INSERT INTO xreaggregator VALUES (2, 1, 'Chronolabs International', 'http://www.chronolabs.org.au/', 'http://www.chronolabs.org.au/backend.php', 'ISO-8859-1', 86400, 0, 1, 0, 1, 1, 10, 0, 10, '', 0, '|all');
...
INSERT INTO xreaggregator_categories VALUES (1, 'XOOPS', 1);