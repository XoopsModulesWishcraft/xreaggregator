<?php
// $Id: admin.php,v 2.02 2008/06/10 15:04:00 wishcraft Exp $
//%%%%%%        Admin Module Name  xreaggregators         %%%%%
define('_AM_DBUPDATED','Database Updated Successfully!');
define('_AM_xreaggregatorS','xreaggregators Configuration');
define('_AM_HLMAIN','xreaggregator Main');
...
define('_AM_WANTDEL','Are you sure you want to delete xreaggregator for %s?');
define('_AM_INVALIDID', 'Invalid ID');
define('_AM_OBJECTNG', 'Object does not exist');
define('_AM_FAILUPDATE', 'Failed saving data to database for xreaggregator %s');
define('_AM_FAILDELETE', 'Failed deleting data from database for xreaggregator %s');
?>
