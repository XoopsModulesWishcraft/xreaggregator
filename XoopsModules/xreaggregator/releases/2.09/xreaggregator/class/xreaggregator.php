...
class xreaggregatorxreaggregator extends XoopsObject
{
	...
	function xreaggregatorxreaggregator()
	{
		...
		$this->initVar('xreaggregator_xml', XOBJ_DTYPE_SOURCE, null, false);
