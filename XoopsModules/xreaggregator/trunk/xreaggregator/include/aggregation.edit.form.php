<?php
	...
	if (defined('XOOPS_DOMAIN_ID')&&class_exists('XoopsFormSelectDomains'))
	{
		$domains_sel = new XoopsFormSelectDomains(_AM_DOMAINS, 'xreaggregator_domains',  explode("|",$hl->getVar('xreaggregator_domains')), 4, true);
